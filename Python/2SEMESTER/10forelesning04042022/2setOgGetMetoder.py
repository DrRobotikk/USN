#PRG1100-2022-set og get metoder

#set'ere og get'ere som metoder for å endre og skrive ut verdier
#på enkelt-attributter

class Student:
    #__init__metoden instansierer objektet med verdier via variablene
